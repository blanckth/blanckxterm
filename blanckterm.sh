...
termux-elf-cleaner termux-apt-repo termux-api termimage ncurses-utils ncurses-ui-libs-static lf asciinema -y && \
apt-get install picom putty -y && \
...
libxfce4util-static libxfce4ui-static -y && \
apt-get install wget curl git man bc nmap xfconf xfconf-static -y && touch $isInsE;
}
cfgEsse () {
